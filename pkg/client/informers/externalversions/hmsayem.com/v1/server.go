...
import (
	...
	versioned "github.com/hmsayem/server-controller/pkg/client/clientset/versioned"
	internalinterfaces "github.com/hmsayem/server-controller/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/hmsayem/server-controller/pkg/client/listers/hmsayem.com/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.HmsayemV1().Servers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.HmsayemV1().Servers(namespace).Watch(context.TODO(), options)
			},
		},
		&hmsayemcomv1.Server{},
		resyncPeriod,
...
func (f *serverInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&hmsayemcomv1.Server{}, f.defaultInformer)
}

func (f *serverInformer) Lister() v1.ServerLister {
	return v1.NewServerLister(f.Informer().GetIndexer())
}
